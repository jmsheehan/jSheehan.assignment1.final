...
public class FastSearch implements FastSearchInterface {
	  ...
	  /**
	     ...
	     */
	                	...
	                	boolean goodInput1=false;
		   		        ...
		   		        do{
		   		        	try{
		   		        		...
		   		        		String throwOut = search.nextLine();
		   		        		System.out.println("String expected - but not received");
		   		        	}
		   		        }while(!goodInput);
		   		        ...
		   		        do{
		   		        	try{
		   		        		...
		   		        		String throwOut = search.nextLine();
		   		        		System.out.println("Double expected - but not received");
		   		        	}
		   		        }while(!goodInput1);
	                	addEntry(term,weight,quick);
	                	break;
	                default:
	     ...
	     public FastSearch() throws Exception{
	  	 ...
	  	 * the user.
	  	 */
	public Map<String, Double> getResults(String subString, boolean quick){
	...
	public List<String> getSubstringList(String subString) {
		List<String> sorted = getResults(subString, quick).entrySet().stream()
	...
	public double weightOf(String term) {
		double weight = 0;
		for (Entry<String, Double> entry : getResults(term, quick).entrySet()) {
			String key = entry.getKey();
			if(key.equals(term)){
	 ...
	 */
	@Override
	public void addEntry(String term, Double weight, boolean quick) {
